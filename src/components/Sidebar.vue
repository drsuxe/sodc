    ...
    <mp-box position="relative">
      ...
      >
        <mp-tooltip position="right" :label="isToggle ? 'Expand' : 'Collapsed'">
          <mp-box as="button" height="7.5" width="7.5" display="flex" align-items="center" justify-content="center" @click="isToggle = !isToggle">
      ...
      sidebarMenus: [
        {
          ...
          menus: [
            ...
            { name: "Reports", icon: "reports", isActive: true },
          ],
        },
        {
          name: "transactions",
